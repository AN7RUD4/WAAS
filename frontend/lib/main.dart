...
//           final role =
//               user['role'] as String? ?? 'user'; // Default to 'user' if missing
//           print(
...
//         } else {
//           print(
//             'Profile fetch failed with status ${response.statusCode}, redirecting to login',
//           );
//           setState(() {
...
//       });
//     }
//     print('Initial page set to: ${initialPage?.runtimeType ?? "null"}');
//   }

//   @override
//   Widget build(BuildContext context) {
//     print('Building MyApp, initialPage: ${initialPage?.runtimeType ?? "null"}');
//     if (initialPage == null) {
